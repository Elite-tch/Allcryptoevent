      ...
      <nav className="flex items-center justify-between p-4">
        ...
        <ul
          ...
          <li className="px-4 py-2 lg:px-2">
            <Link href="/event" className="hover:bg-gray-800 hover:p-2 hover:rounded transition text-white" onClick={closeMenu}>
              Events
            </Link>
          </li>
          <li className="px-4 py-2 lg:px-2">
            <Link href="/services" className="hover:bg-gray-800 hover:p-2 hover:rounded transition text-white" onClick={closeMenu}>
              Services
            </Link>
          </li>
          <li className="px-4 py-2 lg:px-2">
            <Link href="/about" className="hover:bg-gray-800 hover:p-2 hover:rounded transition text-white" onClick={closeMenu}>
              About
            </Link>
          </li>
          <li className="px-4 py-2 lg:px-2">
            <Link href="/blogs" className="hover:bg-gray-800 hover:p-2 hover:rounded transition text-white" onClick={closeMenu}>
              Blogs
            </Link>
          </li>
          <li className="px-4 py-2 lg:px-2">
